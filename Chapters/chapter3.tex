...
Signaling interactions were obtained using the \texttt{import\_omnipath\_interactions} function and with assigned mechanism = 0, whereas transcriptional regulatory interactions imported using import\_transcriptional\_interactions were annotated as mechanism = 1. 
