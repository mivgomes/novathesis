...
\hline
\textbf{\begin{tabular}[c]{@{}l@{}}Query / \\ Reference\end{tabular}} & \textbf{Perturbation} & \textbf{Origin} & \textbf{Signatures} & \textbf{Metabase} & \textbf{OmniPath} & \textbf{Metabase (linear path)} & \textbf{MetaBase (regulons)} & \textbf{OmniPath (regulons)} & \textbf{LINCS CRISPR} & \textbf{LINCS OE} & \textbf{LINCS shRNA} & \textbf{GWPS Perturb-Seq} \\ \hline
...
% \begin{figure}[htbp]
%     \centering
%     \includegraphics[height=4in]{fig4.1.algorithmwin}
...
%     \label{fig:fig4.1.algorithmwin}
% \end{figure}
% %\end{newpdflayout}

\begin{figure}[htbp]
  \centering
  \subbottom[One sub-figure\label{fig:fig4.1.algorithmwin}]{%
    \includegraphics[width=0.5\linewidth]{fig4.1.algorithmwin}}%
  \subbottom[Another sub-figure\label{fig:fig4.1.algorithmWPAE}]{%
...
\begin{figure}[htbp]
    \centering
    \includegraphics[height=4in]{fig4.1.algorithm_final_rank_heatmap}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[height=7in]{fig4.2.reference_wrap_plots}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[height=7in]{fig4.3.query_wrap_plots}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[height=6in]{fig4.3.all_comparisons_faceted_no_rank}
