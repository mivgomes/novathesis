...
>>>>>>> 663a67ed02d61a67b7e13f2909d7b164f5a63d59
...
\ntsetup{color/links=black}% The color for the hyperlinks (URLs, cross references, citations)
%                               %     Valid color names  —> look at "svgname" in the "xcolor"
%                               %                           package documentation
%                               % DEFAULT: a customized dark blue color

\ntsetup{color/gls=black} % The color for the glossary managed hyperlinks (glossary, symbols, etc)
%                               %     Valid color names  —> look at "svgname" in the "xcolor"
%                               %                           package documentation
%                               % DEFAULT: black
