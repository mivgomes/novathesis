...
% Replace "Contedo" with "ndice"
% Replace "ndice" with "ndice Remissivo"
...
\ntlangsetup*{pt/contents=ndice}
\ntlangsetup*{pt/listfigure=ndice de Figuras}
\ntlangsetup*{pt/listtable=ndice de Tabelas}
\ntlangsetup*{pt/index=ndice Remissivo}
\ntlangsetup*{pt/lstlistlisting=ndice de Listagens}
\ntlangsetup*[caption]{pt/listoflistings=ndice de Listagens}
...
\ntlangsetup*{pt/appendixpl=Apndices}
